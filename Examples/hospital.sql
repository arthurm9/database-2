...
-- mostrar médicos organizados em ordem alfabética
SELECT 
    medicos.medico 'MÉDICOS'
FROM
    medicos
ORDER BY medico;

-- mostrar medicos organizdos por especialidade
SELECT 
    especialidade 'ESPECIALIDADE', medico 'MÉDICO'
FROM
    medicos
ORDER BY especialidade;

-- mostrar médicos organizados por cidade e especialidade
SELECT 
    medicos.cidade 'CIDADE',
    medicos.especialidade 'ESPECIALIDADE',
    medicos.medico 'MÉDICO'
FROM
    medicos
ORDER BY cidade , especialidade;

-- mostrar médicos organizados por salario
SELECT 
    medicos.especialidade 'ESPECIALIDADE',
    medicos.medico 'MÉDICO',
    medicos.salario 'SALARIO'
FROM
    medicos
ORDER BY salario;

-- mostrar médicos organizados cidade e ordem alfabética
-- SE cidade JAU ou BAURU
SELECT 
    medicos.cidade 'CIDADE',
    medicos.medico 'MÉDICO',
    medicos.especialidade 'ESPECIALIDADE'
FROM
    medicos
WHERE
    (cidade = 'jau') OR (cidade = 'bauru')
ORDER BY cidade;

-- mostrar médicos organizados por especialidade
-- SE salario maior que 1000 e salario menor que 2000
SELECT 
    medicos.especialidade 'ESPECIALIDADE',
    medicos.medico 'MÉDICO',
    medicos.salario 'SALÁRIO'
FROM
    medicos
WHERE
...
-- mostrar médicos organizados por cidade e especialidade
-- SE cidade = bauru e especialidade = cardiologista e salario maior ou igual a 1500
SELECT 
    medicos.especialidade 'ESPECIALIDADE',
    medicos.cidade 'CIDADE',
    medicos.medico 'MÉDICO',
...
-- mostrar médicos organizados por salario
-- SE cidade = borebi ou agudos e especialidade = urologista ou pediatra
SELECT 
    medicos.salario 'SALÁRIO',
    medicos.cidade 'CIDADE',
    medicos.medico 'MÉDICO',
...
WHERE
    (cidade = 'borebi')
        OR (cidade = 'agudos')
        AND (especialidade = 'urologista')
        OR (especialidade = 'pediatra')
ORDER BY salario;

-- Mostrar somente nome,especialidade e salário dos médicos que moram em botucatu e ganham mais de 20000
